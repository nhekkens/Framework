...
// 1 - Replace particleCloud with new name ( 8 occurences in this file )
// 2 - All code goes into init()
// 3 - Save file as new name .js
var particleCloud = {
    name: 'particleCloud',
    componentInitSelector: '.particleCloud',
    registerComponent: function() {
        if ($(particleCloud.componentInitSelector).length) {
            framework.registerComponent(particleCloud);
        }
    },
    initparticleCloud: function() {
    ...
    init: function() {
        ...
        (function() {
            ...
            var D = 2 * Math.PI,
                f = $('.particleCloud').width(),
                p = $('.particleCloud').height(),
                z = 600,
                B = 0.96,
                A = [],
        ...
        // End
        particleCloud.initparticleCloud();
...
particleCloud.registerComponent();
